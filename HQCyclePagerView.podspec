...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/stevenJiechen/HQCyclePagerView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'stevenJiechen' => '2214312777@qq.com' }
  s.source           = { :git => 'https://github.com/stevenJiechen/HQCyclePagerView.git', :tag => s.version.to_s }
